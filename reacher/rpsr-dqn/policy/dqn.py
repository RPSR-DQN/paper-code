...
def build_network(state_shape, num_actions):
    ...
    network = nn.DenseLayer(network,32, W=W_init, nonlinearity=nonlin)
...
class Agent(object):
    ...
    def __init__(self, state_shape, num_actions, epsilon=1.0, epsilon_min=0.0,
                 epsilon_iter=100000, discount=0.99, lrate=0.0001,

...
class RFFPSR(ControlledModel):
    ...
    def initialize_random(self,  traj_obs, traj_act,traj_act_probs=None):
        ...
        self.W_rff2obs=self.rng.normal(size=(K.obs,d.o)) 
        self._W_s2oo = self.rng.normal(size=(self._p, K.oo*K.act))
        self.W_a_feata= self.rng.normal(size=( d.a,K.act))
        self.W_o_feato= self.rng.normal(size=( d.o,K.obs))
    ...
    def _load(self, params):        
        ...
        self.W_rff2obs =params['W_rff2obs ']
        self.W_o_feato=params['W_o_feato']
        self.W_a_feata=params['W_a_feata']
    ...
    def _save(self):
        params = {}
        params['W_rff2obs ']=self.W_rff2obs 
        params['W_o_feato'] = self.W_o_feato
        params['W_a_feata'] = self.W_a_feata
    ...
    def _build_model(self, data, feats, states): 
        ...
        self.W_rff2obs = ridge(feats.obs, data.obs, self._lambda['pred'])
        self.W_a_feata = ridge(data.act,feats.act,self._lambda['pred'])
        self._W_1s = np.dot(W_1s, self.W_rff2obs)        
        self.W_o_feato = ridge(data.obs,feats.obs,self._lambda['pred'])
